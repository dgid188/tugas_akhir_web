...
<html lang="en">
    <head>
        ...
        <title>Ubah Data Kendaraan | Jasa Harum</title>
    ...
    <body>
                    ...
                    <div class="content-wrapper">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title">Ubah Data kendaraan yang sudah ada</h4>
                                        <form class="form-sample" id="form_kendaraan">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <input type="text" class="form-control" placeholder="Merk" id="merk" disabled />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <input type="number" class="form-control" placeholder="Tahun" id="tahunpembuatan" disabled/>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <input type="text" class="form-control" placeholder="Nomor Mesin" id="nomormesin" disabled/>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <input type="text" class="form-control" placeholder="Nomor Rangka" id="nomorrangka" disabled/>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                <button type="submit" class="btn btn-gradient-primary mr-2">Ubah Data Kendaraan</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
        ...
        <script src="../../scripts/update_data_kendaraan.js"></script>
    </body>
</html>