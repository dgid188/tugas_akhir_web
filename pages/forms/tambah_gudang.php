...
<html lang="en">
    <head>
        ...
        <title>Tambah Gudang | Jasa Harum</title>
    ...
    <body>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form class="form-sample" id="form_harga">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <button type="submit" class="btn btn-gradient-primary mr-2" id="btnharga">Tambah gudang</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
        ...
        <script src="../../scripts/tambah_gudang.js"></script>
    </body>
</html>